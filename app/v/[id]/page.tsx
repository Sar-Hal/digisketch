    ...
    <main className="w-full">
      <div className="flex w-full flex-col gap-6">
        ...
        <div className="rounded-[24px] border-2 border-black bg-white/85 p-5 text-center shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
          ...
          <Link
            href="/create"
            className="mt-4 inline-flex w-fit items-center gap-2 rounded-full border-2 border-black bg-accent px-5 py-2 text-base shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]"
          >
            Make your own
          </Link>
        </div>
